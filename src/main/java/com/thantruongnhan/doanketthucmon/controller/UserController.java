...
public class UserController {
    ...
    public User createUser(
        ...
        return userService.createUser(username, password, fullName, email, phone, role, image);
    }
    ...
    public User updateUser(
        ...
        return userService.updateUser(id, fullName, email, phone, role, isActive, image);
    }
